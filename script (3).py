# Create CRUD implementation files
...
with open('user.types.ts', 'w') as f:
    f.write(user_types)

# User service with CRUD operations
user_service = """import { Pool, QueryResult } from 'pg';
...
with open('user.service.ts', 'w') as f:
    f.write(user_service)

print("CRUD implementation files created successfully!")
print("Files created:")
print("- user.types.ts (TypeScript interfaces)")
print("- user.service.ts (CRUD service with read/write separation)")